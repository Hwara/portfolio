export const PROFILE = {
  ...
  about: [
    "하드웨어/펌웨어 개발 분야에서 5년을 보내고, 클라우드 네이티브 엔지니어링 분야로 전환한 개발자입니다.",
    ...
    "하드웨어 개발을 통해 다양한 트러블슈팅 경험을 얻게 되었습니다. 노이즈 신호로 인한 오류 동작을 해결하기 위해 수십 번의 시제품을 제작하며 문제를 좁혀가는 과정을 반복하였고 결국 문제를 해결하였습니다.",
    ...
    "앞으로의 목표는 동료분들이 믿고 의지할 수 있는 든든한 버팀목같은 엔지니어가 되는 것 입니다.",
    "이 같은 목표를 달성하기 위해 부트캠프 프로젝트에서 팀원이 건강 문제로 잠시 빠지게 되어 인프라 전반을 혼자 담당하게 된 상황에서도 Terraform IaC, Kubernetes 클러스터 구축, 보안 시스템까지 기존 목표한 기능 구현을 완료하는 등의 노력을 다하였습니다.",
  ],
  ...
  skills: [
    "Spring Boot", "Kubernetes", "Terraform", "AWS Cloud", "Git", "GitHub Actions",
